...
from decision_transformer.evaluation.evaluate_episodes_warehouse import evaluate_episode, evaluate_episode_rtg
...
def experiment(
    ...
    if env_name == 'StarCraft2':
        ...
        args = {
            ...
            "n_agents": 2,  # Specify the number of agents
            "episode_limit": 500,
            "difficulty": "easy",
            "seed": 42,
            "render": False,
    ...
    dataset_path = f'data_ma/warehouse/rware_tiny/rware_tiny_1000/expert/rware_tiny_6ag_easy_v4_expert.pkl'
    ...
    if variant['s4_onpolicy_afteroff'] == 0:
        ...
        for iter in range(variant['max_iters']):
            ...
            if current_avg_returns > best_avg_returns:
                ...
                torch.save(current_model.state_dict(), f"rware_small_2ag_expert_dependent_all_agent_id_rew_emb_global_emb_local_emb_prev_emb_act_emb_emb_128_K_500.pkl")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--map_name', type=str, default='rware_small_2ag')
    ...
    fn = "runlog_" + str(vars(args)['env_name']) + "_" + str(vars(args)['map_name']) + "_" + str(
        vars(args)['dataset']) + f"_{prefix2}_{prefix1}_" + "dependent_all_agent_id_rew_emb_global_emb_local_emb_prev_emb_act_emb_emb_128_K_500" + ".log"
