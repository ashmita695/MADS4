...
from decision_transformer.envs.ls import Env
...
def experiment(
    ...
    dataset_path = f'data_ma/smac/3m/good/3m_good.pkl'
    ...
    if variant['s4_onpolicy_afteroff'] == 0:
        ...
        for iter in range(variant['max_iters']):
            ...
            if current_avg_returns > best_avg_returns:
                ...
                torch.save(current_model.state_dict(), f"smac_3m_best_all_dep_sate_emb_act_prev_act_emb_rew_emb.pkl")
...
if __name__ == '__main__':
    ...
    fn = "runlog_" + str(vars(args)['env_name']) + "_" + str(vars(args)['map_name']) + "_" + str(
        vars(args)['dataset']) + f"_{prefix2}_{prefix1}_" + "dependent_all_state_emb_action_prev_act_emb_rew_emb" + ".log"
