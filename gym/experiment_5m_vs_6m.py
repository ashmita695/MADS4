...
def experiment(
    ...
    dataset_path = f'data_ma/smac/5m_vs_6m/5m_vs_6m_1000/good/5m_vs_6m.pkl'
    ...
    env_targets = [50, 25, 20, 15, 10, 8.50, 7.50, 6.50]
    ...
    if variant['s4_onpolicy_afteroff'] == 0:
        ...
        for iter in range(variant['max_iters']):
            ...
            if current_avg_returns > best_avg_returns:
                ...
                torch.save(current_model.state_dict(), f"smac_5m_vs_6m_good_best_dependent_all_agent_id_rew_emb_obs_emb_global_state_emb_prev_act_emb_act_emb_size_128_iter_1000_with_before_real_without_act_emb.pkl")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--K', type=int, default=30) # max sequence length for training
    parser.add_argument('--pct_traj', type=float, default=1.)
    parser.add_argument('--seed', type=int, default=123) #123
    parser.add_argument('--batch_size', type=int, default=64)
    parser.add_argument('--model_type', type=str, default='s4v3')
    parser.add_argument('--embed_dim', type=int, default=128) #128-7.356
    ...
    parser.add_argument('--s4_mode', type=str, default='real')
    ...
    fn = "runlog_" + str(vars(args)['env_name']) + "_" + str(vars(args)['map_name']) + "_" + str(
        vars(args)['dataset']) + f"_{prefix2}_{prefix1}_" + "dependent_all_agent_id_rew_emb_obs_emb_global_state_emb_prev_act_emb_act_size_128_iter_1000_with_before_real_without_act_emb" + ".log"
