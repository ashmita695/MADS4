...
def experiment(
    ...
    dataset_path = f'data_ma/smac/2c_vs_64zg/2c_vs_64zg_1000/good/2c_vs_64zg.pkl'
    ...
    if variant['s4_onpolicy_afteroff'] == 0:
        ...
        for iter in range(variant['max_iters']):
            ...
            if current_avg_returns > best_avg_returns:
                ...
                torch.save(current_model.state_dict(), f"smac_2c_vs_64zg_good_best_independent_all_rew_emb_state_emb_prev_act_emb_action.pkl")
...
if __name__ == '__main__':
    ...
    fn = "runlog_" + str(vars(args)['env_name']) + "_" + str(vars(args)['map_name']) + "_" + str(
        vars(args)['dataset']) + f"_{prefix2}_{prefix1}_" + "independent_all_rew_emb_state_emb_prev_act_emb_action_good" + ".log"
